    ...
    <div class="top_title">
        ...
        <div class="linewrap">
            <div class="login">
                ...
                <a href="go_backend?target=frontpage/user/register" style="text-decoration:none" class="register"> 免费注册</a>
            </div>
            <ul class="nav">
                <div class="nav-item">
                    <li class="spacer"></li>
            ...
            <div class="image">
                <div class="top_right">
                    ...
                    <div class="mycart">
                        ...
                        <a href="shopcart/queryShoppingCart" style="text-decoration: none;" class="cart_text">我的购物车</a>
                    </div>
    ...
    <script>
        $(function()
        {
            function sortRule(a,b) {//这个是用来数组排序的数组函数
                ...
                new network("category/getLevelCategory",{"cparent":-1}).then(function (result) {
                    var htmltext='';
                    ...
                    $('#leftmenu li').mouseenter(function () {//当一级菜单的标签滑动的时候会根据一级菜单来读取二级菜单的项目
                        ...
                        var cname=$(this).html();
                         new network("category/getLevelCategory",{"cparent":cid,"clevel":2})//用来获取二级菜单的数据
                             ...
                             new network("category/selectLevelByGroup",{"cparentArr":JSON.stringify(arr)}).then(function (result2) {
                                 ...
                                 for (var i=0,j=0;i<result1.length&&j<result2.length;j++)
                                 {
                                     ...
                                     if (is_first)
                                     {
                                         ...
                                         content_html+=`<div class="word"><a style="color: #666;text-decoration: none;"  href="product/getPageByQuery?target=frontpage/product/Productlist&searchCondition=上架&requestPage=1&perPageRecordCount=8&cid=`+result2[j].cid+`">`+result2[j].cname+`</a></div>`;
                                 }
