<%@ page language="java" import="java.util.*,com.vo.*,com.service.inner.*,com.service.impl.*" pageEncoding="UTF-8"%>
    ...
    <script>
        $(function () {
            ...
            $("#btn-login").click(function () {
                ...
                $.post("user/frontCheckLogin",{username:username,password:password},function(data){
                    var ischeck=JSON.parse(data)
                    if (ischeck)
                    {
                        window.location.assign('go_backend?target=frontpage/user/welcome');
                    }
                    else
                    {
                        loginmun++;
                        ...
                        if (loginmun>=3) {
                            $.post("user/frontLockUser",{username:username},function(data){
                                alert(data)
                            },"json");
                        }
                    }
    ...
    <div class="main-c">
        <div class="login-block">
            ...
            <div class="concat">
                ...
                <div class="box reg">
                    <div class="icon"></div>
                    <a href="go_backend?target=frontpage/user/register">立即注册</a>
                    <!-- 立即注册 -->
                </div>
            </div>
        </div>
