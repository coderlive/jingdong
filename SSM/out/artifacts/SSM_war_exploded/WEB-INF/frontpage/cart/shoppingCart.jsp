...
<script type="text/javascript">
    $(function () {
        ...
        $('.changeCartSum').click(function () {
            ...
            //修改购物车的商品数量
            new network('shopcart/changeCartCount',{"pid":pid,"count":count}).then(function () {
                console.log("???")
            });
        ...
        $('#go_pay').click(function () {
            ...
            location.assign("order/addOrder?subject="+subject+"&total_amount="+total_amount+"&pids="+jsonPids);
        })
    })
