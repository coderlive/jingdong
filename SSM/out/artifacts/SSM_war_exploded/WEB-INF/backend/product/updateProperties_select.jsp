...
<div class="centerDiv">
    ...
    <div class="myFormDiv">
        <form action="properties_select/update" method="post">
            <input type="hidden" name="requestPage" value="<%=requestPage%>"/>
            <!--0.8 搜索功能 加入隐藏域searchCondition-->
            <input type="hidden" name="searchCondition" value="<%=searchCondition%>"/>
            <input type="hidden" name="psid" value="${properties_select.psid}"/>
            <div class="inputDiv"><label class="myFormLabel">属性值所属属性id</label><input type="text"  class="jdInput"name="pid" value="${properties_select.pid}"/></div>
            <div class="inputDiv"><label class="myFormLabel">属性值名称</label><input type="text" class="jdInput"name="psname" value="${properties_select.psname}"/></div>
