<%@ page language="java" import="java.util.*" import="com.vo.Orders,com.page.PageInfo"
...
<div id="categoryDiv">
	...
	<div class="pageDiv">
		...
		<form id="categoryForm" action="order/find" method="post">
			<input type="hidden" name="searchCondition" value='${requestScope.searchCondition}'/>
			<a id="first" class="btn btn-default btn-sm" href="order/find?searchCondition=${requestScope.searchCondition}&requestPage=1">首页</a>


			<a id="previous" class="btn btn-default btn-sm"
			   href="order/find?searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>"> 上一页</a>
			<a id="next" class="btn btn-default btn-sm"
			   href="order/find?searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>"> 下一页</a>


			<a id="last" class="btn btn-default btn-sm"
			   href="order/find?searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getTotalPageCount()%>">尾页</a>
...
<script type="text/javascript">
    ...
    function deleteCategoryById(id) {
        $.confirm({
            ...
            confirm: function () {
                ...
                location.assign("order/deleteById?searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getCurrentPage()%>&oid=" + id);
            },
            cancel: function () {
    ...
    function getOneForUpdate(id) {
        ...
        location.assign("order/getOneForUpdate?searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getCurrentPage()%>&oid=" + id);
    }
</script>
