...
<body>
	...
	<form action="product/uploadImage" method="post" enctype="multipart/form-data">
		<input type="hidden" name="pid" value="<%=product.getPid()%>"/>
		<fieldset id="imageUploadFieldset">
			<legend>上传图片</legend>
				<div id="productInfo">
					<div id="productId">
							<label class="productInfoLabel">商品id</label>
							<%=product.getPid()%>
					</div>
		
					<div id="productName">
							<label class="productInfoLabel" >商品名称</label>
				...
				<fieldset class="listFieldset">
						...
						<div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>大图片</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div>
							
								<div class="categoryClass2">
									<label>小图片1</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div> 
							</div>
							
							<div class="listFieldsetDiv">
								<div class="categoryClass3">
									<label>小图片2</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div>
								
								<div class="categoryClass4">
									<label>小图片3</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div> 
							</div>
						</div>
					...
					<legend>产品详细页图片</legend>
						<div>
							...
							<div class="listFieldsetDiv">
								<div class="categoryClass3">
									<label>小图片4</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div>
								
								<div class="categoryClass4">
									<label>小图片5</label><input type="file"  name="cdesc"  class="btn-warning"/>
								</div> 
							</div>
						</div>
