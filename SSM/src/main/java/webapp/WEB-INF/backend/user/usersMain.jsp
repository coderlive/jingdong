...
<div id="categoryDiv">
    ...
    <form id="categoryForm" action="user/getPageByQuery.action" method="get">
        <input name="target" type="hidden" value="/backend/user/usersMain">
    ...
    <div class="text-center categoryTableDiv">
        ...
        <div class="pageDiv">
            <form id="productForm2" action="user/getPageByQuery.action?target=/backend/user/usersMain"
                  method="post">
                <a id="first" class="btn btn-default btn-sm"
                   href='user/getPageByQuery.action?target=/backend/user/usersMain&searchCondition=${searchCondition}&requestPage=1'>首页</a>


                <a id="previous" class="btn btn-default btn-sm"
                   href='user/getPageByQuery.action?target=/backend/user/usersMain&searchCondition=${searchCondition}&requestPage=${pageInfo.previousPage}'>
                    上一页</a>
                <a id="next" class="btn btn-default btn-sm"
                   href='user/getPageByQuery.action?target=/backend/user/usersMain&searchCondition=${searchCondition}&requestPage=${pageInfo.nextPage}'>
                    下一页</a>


                <a id="last" class="btn btn-default btn-sm"
                   href='user/getPageByQuery.action?target=/backend/user/usersMain&searchCondition=${searchCondition}&requestPage=${pageInfo.totalPageCount}'>尾页</a>
    ...
    <script type="text/javascript">
        ...
        function usersUnlock(userid) {
            $.confirm({
                ...
                confirm: function () {
                    //发请求
                    location.assign("user/updateActive.action?target=/backend/user/usersMain&uenable=0&searchCondition=${searchCondition}&requestPage=${pageInfo.getCurrentPage()}&userid=" + userid);
                },
                cancel: function () {
        ...
        function usersLock(userid) {
            $.confirm({
                ...
                confirm: function () {
                    //发请求
                    location.assign("user/updateActive.action?target=/backend/user/usersMain&uenable=1&searchCondition=${searchCondition}&requestPage=${pageInfo.getCurrentPage()}&userid=" + userid);
                },
                cancel: function () {
