...
<div id="categoryDiv">
    ...
    <div class="text-center categoryTableDiv">
        ...
        <div class="pageDiv">
            <form id="productForm2" action="login?action=getAllUsers&target=/user/usersActiveMain"
                  method="post">
                <a id="first" class="btn btn-default btn-sm"
                   href='login?action=getAllByPage&target=/user/usersActiveMain&searchCondition=${searchCondition}&requestPage=1'>首页</a>


                <a id="previous" class="btn btn-default btn-sm"
                   href='login?action=getAllByPage&target=/user/usersActiveMain&searchCondition=${searchCondition}&requestPage=${pageInfo.previousPage}'>
                    上一页</a>
                <a id="next" class="btn btn-default btn-sm"
                   href='login?action=getAllByPage&target=/user/usersActiveMain&searchCondition=${searchCondition}&requestPage=${pageInfo.nextPage}'>
                    下一页</a>


                <a id="last" class="btn btn-default btn-sm"
                   href='login?action=getAllByPage&target=/user/usersActiveMain&searchCondition=${searchCondition}&requestPage=${pageInfo.totalPageCount}'>尾页</a>
    ...
    <script type="text/javascript">
        ...
        function usersUnactive(userid) {
            $.confirm({
                ...
                confirm: function () {
                    //发请求
                    location.assign("login?action=updateActive&target=/admin/user/usersActiveMain&isActive=0&searchCondition=${searchCondition}&requestPage=${pageInfo.getCurrentPage()}&userid=" + userid);
                },
                cancel: function () {
        ...
        function usersActive(userid) {
            $.confirm({
                ...
                confirm: function () {
                    //发请求
                    location.assign("login?action=updateActive&target=/admin/user/usersActiveMain&isActive=1&searchCondition=${searchCondition}&requestPage=${pageInfo.getCurrentPage()}&userid=" + userid);
                },
                cancel: function () {
