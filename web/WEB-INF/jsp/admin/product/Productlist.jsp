<%@ page language="java"
         import="java.util.*,vo.Products,page.PageInfo"
         pageEncoding="UTF-8" %>
                        ...
                        <a href="" class="link link1" target="_blank">京东客户端</a> <a
                            ...
                            href="" class="link link4">新人专享188元大礼包</a> <a href=""
                                                                          class="link link5">扫一扫封顶立减999元</a> <a href=""
                                                                                                                class="applink jdapp-ios"
                                                                                                                target="_blank">京东客户端ios版</a>
                        <a
        ...
        <div id="search-2014">
            <form id="categoryForm"
                ...
                <div class="form">
                    ...
                    <input type="hidden" name="target" value="/admin/product/Productlist">
            ...
            <div class="m-list">
                <div class="ml-wrap">
                        ...
                        <div class="f-pager">
								<span class="fp-txt"> <b><%=pageInfo.getCurrentPage()%></b>
									<em>/</em> <i><%=pageInfo.getTotalPageCount()%></i>
                                           ...
                                           href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&target=/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>">
                            <</a> <a id="fp-nextLink" class="fp-next"
                                     href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&target=/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>">></a>
                        </div>
                    </div>
                    ...
                    <div id="plist" class="good-list-v1">
                        <ul class="gl-wrap">
                            ...
                            <li class="gl-item">
                                <div class="gl-i-wrap">
                                    <div class="p-img">
                                        <a href="ProductServlet?action=getOneForUpload&pid=${p.pid}&target=/product/productDetail">
                                    ...
                                    <div class="p-scroll">
                                        <div class="ps-wrap">
                                            <ul class="ps-main">
                                                <li class="ps-item">
                                                    <a href="#" class="plsm_curr">
                                                        <img width="25px" height="25px" src="img/productImage/${p.product_list_small_image1}" />
                                                    </a>
                                                </li>
                                                <li class="ps-item">
                                                    <a href="#">
                                                        <img width="25px" height="25px" src="img/productImage/${p.product_list_small_image2}" />
                                                    </a>
                                                </li>
                                                <li class="ps-item">
                                                    <a href="#">
                                                        <img width="25px" height="25px" src="img/productImage/${p.product_list_small_image3}" />
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="p-name">
                                        <a href="javascript:0;">
                                            <em>${p.pname}</em>
                                            <i class="promo-words">红米手机，上亿人次的选择！指纹识别， 待机长/金属机身，不可思议的蜕变！买小米挚爱·不等待·就现在【更多惊喜请点击】</i>
                                        </a>
                    ...
                    <div class="page">
                        <div class="p-wrap">
									<span class="p-num">
									<a id="previous" href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>" class="pn-prev">
										<i><</i>
										<em>上一页</em>
									</a>
                                    ...
                                    %>
												<a pageNum="pageNum" href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=i%>"><%=i%></a>
									<%
                                        }
                                    ...
                                    %>
                                        <!--  打印..-->
												<b class="pn-break">...</b>
                                        <!-- 打印最后一页(即总共的页数) -->
												<a pageNum="pageNum" href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=totalPageCount%>"><%=totalPageCount%></a>
									<%
                                    }else if(currentPage<totalPageCount-3){//当前页<总页数-3   8
                                    %>
                                        <!--始终打印10个
                                        先打印1  和 ..  -->
												<a pageNum="pageNum" href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=1">1</a>
												<b class="pn-break">...</b>
									<%
									...
									<a id="next" href="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&target=/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>" class="pn-prev">
										<em>下一页</em>
										<i>></i>
									</a>
								</span>
                            ...
                            <span class="p-skip">
									<form id="productForm2" action="ProductServlet?action=getPageByQuery&target=/admin/product/Productlist&perPageRecordCount=8&cid=${product.cid}&searchCondition=${requestScope.searchCondition}&cid=${product.cid}" method="post">
    ...
    $(function () {
        ...
        $("#price").click(function () {
            ...
            if (lastAscOrDesc == "asc") {//先降序
                ...
                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=price&ascOrDesc=desc&cid=${product.cid}";

                location.assign(target);
            } else if (lastAscOrDesc == "desc") {

                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=price&ascOrDesc=asc&cid=${product.cid}";
        ...
        $("#xiao_liang").click(function () {
            ...
            if (lastAscOrDesc == "asc") {//先降序
                ...
                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=xiao_liang&ascOrDesc=desc&cid=${product.cid}";

                location.assign(target);
            } else if (lastAscOrDesc == "desc") {

                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=xiao_liang&ascOrDesc=asc&cid=${product.cid}";
        ...
        $("#pingjia_sum").click(function () {
            ...
            if (lastAscOrDesc == "asc") {//先降序
                ...
                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=pingjia_sum&ascOrDesc=desc&cid=${product.cid}";

                location.assign(target);
            } else if (lastAscOrDesc == "desc") {

                var target = "ProductServlet?action=getPageByQuery&perPageRecordCount=8&target=/admin/product/Productlist&searchCondition=${requestScope.searchCondition}&requestPage=1&orderCondition=pingjia_sum&ascOrDesc=asc&cid=${product.cid}";
