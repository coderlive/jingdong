...
<div id="categoryDiv">
    <!--0.8 搜索功能 加入搜索框-->
    <form id="categoryForm2" action="Properties_selectServlet?action=getPageByQuery" method="post">
    ...
    <div class="pageDiv">
        ...
        <form id="categoryForm" action="Properties_selectServlet" method="post">
            ...
            <a id="first" class="btn btn-default btn-sm" href="Properties_selectServlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=1">首页</a>


            <a id="previous" class="btn btn-default btn-sm"
               href="Properties_selectServlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getPreviousPage()%>"> 上一页</a>
            <a id="next" class="btn btn-default btn-sm"
               href="Properties_selectServlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getNextPage()%>"> 下一页</a>


            <a id="last" class="btn btn-default btn-sm"
               href="Properties_selectServlet?action=getPageByQuery&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getTotalPageCount()%>">尾页</a>
...
<script type="text/javascript">
    ...
    function deleteById(id) {
        $.confirm({
            ...
            confirm: function () {
                ...
                location.assign("Properties_selectServlet?action=delete&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getCurrentPage()%>&psid=" + id);
            },
            cancel: function () {
    ...
    function getOneForUpdate(id) {
        ...
        location.assign("Properties_selectServlet?action=getOneForUpdate&searchCondition=${requestScope.searchCondition}&requestPage=<%=pageInfo.getCurrentPage()%>&psid=" + id);
    }
