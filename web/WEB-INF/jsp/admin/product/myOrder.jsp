...
<%@ page import="service.inner.OrderDetailService" %>
<%@ page import="service.impl.OrderDetailServiceImpl" %>
<%@ page import="vo.OrderDetail" %>
<%@ page import="dao.inner.Dao" %>
<%@ page import="dao.impl.DaoImpl" %>
<%@ page import="vo.Products" %>
<%
			...
			<div id="content">
				...
				<div id="main">
                	...
                	<div id="order02" class="mod-main mod-comm lefta-box" >
                		<div class="mt">
	                        <ul class="extra-l">
	                            <li class="selected" id="sx"><a href="javascript:0" class="txt curr">全部订单</a></li>
	                            <li><a href="javascript:0" id="ordertoPay" class="txt">待付款</a><a href="#"><%if(count!=0){%><em><%=count%></em><%}%></a></li>
	                            <li><a href="javascript:0" id="ordertoReceive"  class="txt">待收货<%if(count2!=0){%><em><%=count2%></em><%}%></a></li>
		                		...
		                		<table class="td-void order-tb">
                                    ...
                                    <%
                                        ...
                                        for(Orders ll:list){
                                           ...
                                           String oid = ll.getOid().toString();
                                           List<OrderDetail> list1 = orderDetailService.selectOrderDetailByOrderId(oid);
                                            if(ll.getStatus()==0){
                                    %>
                                    ...
                                    <tr class="tr-th">
                                        <td colspan="5">
                                            <span class="gap"></span>
                                            <span class="dealtime" title="<%=ll.getOrder_time()%>"><%=ll.getOrder_time()%></span>
                                            <input id="datasubmit-22964031644" value="<%=ll.getOrder_time()%>" type="hidden">
                                    ...
                                    <%
                                        for(OrderDetail lll:list1){
                                            String pid = lll.getPid().toString();
                                            Products products = (Products) dao.getOneById(Integer.parseInt(pid),Products.class);
                                            int sum = products.getPrice()*products.getProduct_sum();
                                    %>
																...
																<div class="logistics-cont" id="tracker22964031644">
																	<ul>
																		<li class="first"><i class="node-icon"></i>
																			...
																			<div class="ftx-13"><%=ll.getOrder_time()%></div>
																		</li>
																	</ul>
																</div>
															</div>
                                    ...
                                    <%
                                            for(OrderDetail l1:list1){
                                                String pid = l1.getPid().toString();
                                                Products products = (Products) dao.getOneById(Integer.parseInt(pid),Products.class);
                                                int sum = products.getPrice()*products.getProduct_sum();
                                    %>
									<tbody id="tb-22964031644">
										...
										<tr class="tr-bd" id="track22964031644" oty="0,4,70">
											<td>
												...
												<div class="goods-number">x<%=l1.getOrder_sum()%></div>
