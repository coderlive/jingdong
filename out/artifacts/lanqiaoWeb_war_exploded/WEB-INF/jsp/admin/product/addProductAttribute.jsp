...
<div class="centerDiv">
    ...
    <div class="myFormDiv">
        <form action="AttributeServlet" method="post">
            <input type="hidden" name="action" value="addAttribute"/>
            <input type="hidden" name="target" value="/admin/product/productMainAttribute"/>
            <div class="inputDiv"><label class="myFormLabel">商品类型id</label><input type="text" class="jdInput"name="cid" placeholder="请输入商品类型id"/></div>
            <div class="inputDiv"><label class="myFormLabel">商品属性1</label><input type="text" class="jdInput"name="attribute" placeholder="请输入商品属性1"/></div>
            <div class="inputDiv"><label class="myFormLabel">商品属性2</label><input type="text" class="jdInput"name="attribute" placeholder="请输入商品属性2"/></div>
            <div class="inputDiv"><label class="myFormLabel">商品属性3</label><input type="text" class="jdInput"name="attribute" placeholder="请输入商品属性3"/></div>
